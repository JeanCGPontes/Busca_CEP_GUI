...
class MainWindow(QMainWindow, QWidget):
    def __init__(self):
        ...
        self.Arial_Narrow_16 = functions.get_font("Arial Narrow", 16)
        self.Arial_Narrow_14 = functions.get_font("Arial Narrow", 14)
        ...
        self.map_image_label.setStyleSheet("""QLabel { border-color: rgb(0, 0, 0, 150);
        ...
        self.cep_number.setStyleSheet("""QLineEdit { background-color: rgb(255, 255, 255);
                                          ...
                                          border-style: solid;
                                          border-radius: 2; }""")
        self.cep_number.setFont(self.Arial_Narrow_16)
        ...
        self.search_button.setStyleSheet("""QPushButton { background-color: rgb(158, 190, 248);
                                                          border-color: rgb(0, 0, 0, 150);
                                                          border-width: 1px;
                                                          border-style:solid;
                                                          border-radius: 2; }
                                      QPushButton:hover { background-color: rgb(158, 190, 248, 200) }""")
        self.search_button.setFont(self.Arial_Narrow_14)
        ...
        default_style = ("""QLabel { background-color: rgb(255, 255, 255);
                                     ...
                                     border-style: solid;
                                     border-radius: 0; }""")
        self.street_label = functions.create_label(self.information_frame, 5, 5, 380, 55, default_style, self.Arial_Narrow_14, 5)
        self.district_label = functions.create_label(self.information_frame, 5, 65, 380, 55, default_style, self.Arial_Narrow_14, 5)
        self.city_label = functions.create_label(self.information_frame, 5, 125, 380, 55, default_style, self.Arial_Narrow_14, 5)
        self.state_label = functions.create_label(self.information_frame, 5, 185, 380, 55, default_style, self.Arial_Narrow_14, 5)
    ...
    def search_cep(self, cep):
        ...
        if web_request_response.status_code == 200:
        ...
        elif web_request_response.status_code == 400:
            self.cep_number.setText('')
